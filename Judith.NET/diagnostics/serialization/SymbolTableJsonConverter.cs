...
//    public override void WriteJson (JsonWriter writer, analysis.OLD_DELETE_SymbolTable? value, JsonSerializer serializer) {
//        if (value == null) {
//            writer.WriteNull();
//            return;
//        }
...
//    }
//
//    public override analysis.OLD_DELETE_SymbolTable ReadJson (JsonReader reader, Type objectType, analysis.OLD_DELETE_SymbolTable? existingValue, bool hasExistingValue, JsonSerializer serializer) {
